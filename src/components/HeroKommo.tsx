    ...
    <section className="relative min-h-screen flex flex-col items-center justify-center pt-24 md:pt-28 pb-12 md:pb-16 overflow-hidden bg-white">
      ...
      <div className="relative z-10 mx-auto max-w-6xl px-4 sm:px-6 w-full">
        <div className="text-center mb-12">
          ...
          >
            <a href="https://app.botfy.io/register" className="no-underline inline-flex w-full sm:w-auto px-8 py-3.5 rounded-full bg-accent-purple text-white font-bold text-[15px] hover:bg-accent-purple/90 transition-[background-color,transform] duration-200 shadow-lg shadow-brand-primary/30 hover:-translate-y-0.5 items-center justify-center">
              {k.tryFreeCta}
            </a>
