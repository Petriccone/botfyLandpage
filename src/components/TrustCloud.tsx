                ...
                <div className="relative flex overflow-hidden">
                    ...
                    >
                        {[...companies, ...companies].map((name, i) => (
                            <span key={i} className="text-2xl md:text-3xl font-display font-black text-text-muted/30 hover:text-text-muted/60 transition-colors uppercase tracking-tighter">
                                {name}
                            </span>
                        ))}
                    </motion.div>
