...
const icons = [Cpu, FileText, Shield, Globe, Zap, BarChart3]
        ...
        <section className="py-32 bg-black relative overflow-hidden">
            <div className="max-w-7xl mx-auto px-6 lg:px-8">
                ...
                >
                    ...
                    <h2 className="text-4xl md:text-7xl font-display font-bold tracking-tight mb-8 max-w-4xl text-white leading-[1.05]">
                        Standard AI is too slow. <br />
                        <span className="opacity-40">Botfy is built for</span> <span className="text-white">real-time scale.</span>
                    </h2>
                </motion.div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-12 gap-6 auto-rows-[280px]">
                    ...
                    <motion.div
                        ...
                        viewport={{ once: true }}
                        className="md:col-span-8 row-span-2 bento-card border-none bg-gradient-to-br from-[#0a0a0a] to-[#050505] p-12 flex flex-col justify-end group overflow-hidden"
                    >
                        ...
                        <div className="relative z-10">
                            <h3 className="text-3xl font-bold text-white mb-4">{t.features.items[0].title}</h3>
                    ...
                    >
                        ...
                        <div>
                            <h3 className="text-xl font-bold text-white mb-2">{t.features.items[4].title}</h3>
                    ...
                    >
                        ...
                        <div>
                            <h3 className="text-xl font-bold text-white mb-2">{t.features.items[2].title}</h3>
                    ...
                    >
                        ...
                        <div>
                            <h3 className="text-xl font-bold text-white mb-2">{t.features.items[3].title}</h3>
                    ...
                    >
                        ...
                        <div>
                            <h3 className="text-xl font-bold text-white mb-2">{t.features.items[1].title}</h3>
